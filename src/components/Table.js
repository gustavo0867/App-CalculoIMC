    ...
    return(
        <View style={styleList.table}>
            <View style={[styleList.tableRow, styleList.tableHeaderRow]}>
                <Text style={[styleList.tableColumn, styleList.tableColumnTxtHeader]}> IMC </Text>
                <Text style={[styleList.tableColumn, styleList.tableColumnTxtHeader]}>  Estado </Text>
            </View>
            <View style={styleList.tableRow}>
                ...
                <Text style={[styleList.tableColumn, styleList.tableColumnLevel1, props.levelBmi == 1? styleList.tableColumnActive : null]}> Abaixo do peso </Text>
            </View>
            <View style={styleList.tableRow}>
                ...
                <Text style={[styleList.tableColumn, styleList.tableColumnLevel2, props.levelBmi == 2? styleList.tableColumnActive : null]}> Saudável </Text>
            </View>
            <View style={styleList.tableRow}>
                ...
                <Text style={[styleList.tableColumn, styleList.tableColumnLevel3, props.levelBmi == 3? styleList.tableColumnActive : null]}> Sobrepeso </Text>
            </View>
            <View style={styleList.tableRow}>
                ...
                <Text style={[styleList.tableColumn, styleList.tableColumnLevel4, props.levelBmi == 4? styleList.tableColumnActive : null]}> Obesidade </Text>
            </View>
            <View style={styleList.tableRow}>
                <Text style={[styleList.tableColumn, styleList.tableColumnLevel5, props.levelBmi == 5? styleList.tableColumnActive : null]}> 35 &gt; </Text>
                <Text style={[styleList.tableColumn, styleList.tableColumnLevel5, props.levelBmi == 5? styleList.tableColumnActive : null]}> Extremamente Obeso </Text>
            </View>
        </View>
    )
}
