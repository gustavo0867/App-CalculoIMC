...
export default function Form(){
    ...
    function calc(){
        if(height > 0 && weight > 0) {
            ...
            Alert.alert('Warning', 'Please make sure all fields are filled in correctly')
        }
    }
        ...
        <View style={styleList.containerForm}>
            <View style={styleList.containerInput}>
                <View style={styleList.containerData}>
                    <Text style={styleList.txt}> Height (m): </Text>
                    <TextInput 
                ...
                <View style={styleList.containerData}>
                    <Text style={styleList.txt}> Weight (kg): </Text>
                    <TextInput 
                     style={styleList.input}
                     placeholder='Ex.: 70'
            ...
            <View style={styleList.containerBtn}>
                    <TouchableOpacity style={styleList.btn} activeOpacity={0.7} onPress={reset}>
                        <Text style={styleList.btnText}> Reset </Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styleList.btn} activeOpacity={0.7} onPress={calc}>
                        <Text style={styleList.btnText}> Calculate </Text>
                    </TouchableOpacity>
            </View>

            <Text style={styleList.resultTxt}>Result: {level == null ? 0 : bmi} </Text>   
